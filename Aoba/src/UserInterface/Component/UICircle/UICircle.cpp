#include "Aoba/Component/UICircle.hpp"
...
namespace s3d::aoba {
    ...
    void UICircle::updateMouseIntersection() {
        _updateMouseCondition(m_circle.leftClicked(),
                              m_circle.leftReleased(),
                              m_circle.leftPressed(),
                              m_circle.rightClicked(),
                              m_circle.rightReleased(),
                              m_circle.rightPressed(),
                              m_circle.mouseOver());
    }
}
